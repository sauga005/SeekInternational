...
export const ApplicationProcedures = (props) => {
  return (
    <>
    <div class="card text-bg-dark spaceToph">
        <img src="images/vasily-koloda-8CqDvPuo_kI-unsplash.jpg" class="card-img" alt="..."/>
    ...
    <div className="Documentations">
        <h2>Documenatation</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim quisquam esse soluta accusamus quidem. Laudantium iste aliquid asperiores unde quos eaque ducimus commodi error, ratione rem at laboriosam ab excepturi!</p>
