...
export const UKProviders = (props) => {
  return (
    <>
    <div className="card text-bg-dark spaceToph">
    <img src="images/mike-benna-E5LYZPRuG2A-unsplash.jpg" className="card-img" alt="..."/>
    ...
    <div className="imgContainerPage">
        <img src="images/endri-killo-CYmlYY3-n3A-unsplash.jpg" alt="" />
    </div>
